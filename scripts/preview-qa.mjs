...
const srv=spawn('python3',['-m','http.server','4182','--directory','_site','--bind','127.0.0.1'],{stdio:'inherit'});
...
try{
  ...
  await browser.close();
  console.log('MAGIC40_INDEPENDENT_PREVIEW_WEBKIT PASS '+passed+'/'+passed);
